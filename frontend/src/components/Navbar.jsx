...
function Navbar() {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 transition-all duration-300 dark:bg-slate-900 dark:text-white ${
        sticky
        ...
        <div className="navbar px-0">
          ...
          <div className="navbar-end gap-4">
            ...
            <label className="swap swap-rotate">
              ...
              <button className="bg-black text-white px-4 py-2 rounded-md hover:bg-slate-800 transition-all active:scale-95 shadow-lg cursor-pointer"
               onClick={()=> {
